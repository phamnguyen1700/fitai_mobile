...
class PlanDemoBody extends StatefulWidget {
  const PlanDemoBody({super.key});

  @override
  State<PlanDemoBody> createState() => _PlanDemoBodyState();
}

class _PlanDemoBodyState extends State<PlanDemoBody> {
  int _planIndex = 0;
  int _dayIndex = 0;
